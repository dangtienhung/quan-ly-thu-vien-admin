...
export const ExpireConfirmDialog: React.FC<ExpireConfirmDialogProps> = ({
	open,
	onOpenChange,
	reservation,
	onConfirm,
	...
	const handleConfirm = () => {
		onConfirm(reason || `Đánh dấu hết hạn bởi thủ thư`);
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-md">
				<DialogHeader>
					<DialogTitle>Xác nhận đánh dấu hết hạn</DialogTitle>
					<DialogDescription>
						Đặt trước này đã quá hạn. Bạn có chắc chắn muốn đánh dấu hết hạn
						không?
					</DialogDescription>
				</DialogHeader>
				...
				<div className="space-y-4">
					...
					{/* Lý do đánh dấu hết hạn */}
					<div className="space-y-2">
						<Label htmlFor="reason">Lý do đánh dấu hết hạn (tùy chọn)</Label>
						<Textarea
							id="reason"
							placeholder="Nhập lý do đánh dấu hết hạn..."
							value={reason}
					...
					<div className="bg-orange-50 border border-orange-200 rounded-lg p-3">
						<div className="flex items-start gap-2">
							...
							<div className="text-sm text-orange-800">
								...
								<p>
									Hành động này sẽ đánh dấu đặt trước hết hạn và không thể hoàn
									tác. Hệ thống sẽ:
								</p>
								<ul className="mt-1 space-y-1 text-xs">
									<li>• Cập nhật trạng thái đặt trước thành "Hết hạn"</li>
									<li>• Cập nhật yêu cầu mượn sách tương ứng thành "Đã hủy"</li>
									<li>• Trả sách về trạng thái sẵn sàng</li>
									<li>• Gửi thông báo đến độc giả về việc hết hạn</li>
								</ul>
							</div>
						</div>
					</div>
